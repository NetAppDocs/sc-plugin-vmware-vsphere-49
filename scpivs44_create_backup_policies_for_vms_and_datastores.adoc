...
+
For information about how administrators assign resources to users, refer to https://docs.netapp.com/us-en/snapcenter/get-started/rbac-snapcenter.html[SnapCenter information on using role-based access control^].
